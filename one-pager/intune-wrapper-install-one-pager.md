...
Use segment banners for major script regions so the code is readable at a glance. Use this exact shape, uppercase titles, and only for major regions:
